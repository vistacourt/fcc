...
function randomQuote(){
  ...
  var items = [["You know why, mister? 'Cause you drove a Hyundai to get here tonight, I drove an eighty thousand dollar BMW. That's my name.<br/><br/>"+"<auth> - Blake</auth>"],
                    ...
                    ["I like everything about religion except god.<br/><br/>"+"<auth> - Thomas Kelly</auth>"],
                    ["The Druids... no one knows who they were or what they were doing.<br/><br/>"+"<auth> - Nigel Tufnel</auth>"],
                    ["I like to picture Jesus in a tuxedo t-shirt, cause it says, like, I want to be formal but I want to party too. Cause I like to party, so I like my Jesus to party.<br/><br/>"+"<auth> - Cal Naughton Jr.</auth>"],
                    ["Hey, wait a minute, there's no birthday party for me here!<br/><br/>"+"<auth> - Jeff Spicoli</auth>"],
                    ["Who picks your clothes - Stevie Wonder?<br/><br/>"+"<auth> - Don Rickles</auth>"],
                    ["Welcome to Costco, I love you.'<br/><br/>"+"<auth> - Guy at Costco</auth>"],
                    ["Carl's Jr... Fuck you, I'm eating<br/><br/>"+"<auth> - Carl's Jr. Computer</auth>"],
                    ["If I were running The View, I’d fire Rosie O’Donnell. I mean, I’d look at her right in that fat, ugly face of hers, I’d say Rosie, you’re fired.<br/><br/>"+"<auth> - Donald Trump</auth>"],
                    ["I don't even listen to rap. My aprtment is too nice for it.<br/><br/>"+"<auth> - Kanye West</auth>"],
                    ["My greatest pain in life is that I will never be able to see myself perform live.<br/><br/>"+"<auth> - Kanye West</auth>"],
                    ["I have five of broats.<br/><br/>"+"<auth> - Dr. Steve Brule</auth>"],
                    ["I basically love anything that comes in a hot dog bun… except hot dogs.<br/><br/>"+"<auth> - Gwyneth Paltrow</auth>"],
                  ];
